...
export function Sidebar({ 
  ...
  return (
    <>
      ...
      {/* Mobile toggle button - optimized positioning */}
      <button
        onClick={onToggle}
        className="fixed top-3 left-3 z-50 lg:hidden bg-white/90 backdrop-blur-sm rounded-xl p-2.5 shadow-lg border border-gray-200 hover:bg-white hover:shadow-xl transition-all duration-200 flex items-center justify-center"
      >
      ...
      `}>
        ...
        <div className="p-3 sm:p-4 flex-shrink-0">
          ...
          <button
            onClick={onNewChat}
            className="w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-medium py-2.5 sm:py-3 px-4 rounded-xl sm:rounded-2xl transition-all duration-200 flex items-center justify-center group text-sm shadow-lg hover:shadow-xl"
          >
          ...
          <div className="space-y-1 sm:space-y-2">
            {conversations.length === 0 ? (
              <div className="text-center py-6 sm:py-8 text-gray-500">
                <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-r from-purple-500 to-purple-600 flex items-center justify-center shadow-lg mx-auto mb-3 sm:mb-4 opacity-60">
              ...
              <>
                {conversations.map((conversation) => (
                  <div
                    key={conversation.id}
                    className={`
                      group relative rounded-xl sm:rounded-2xl transition-all duration-200 cursor-pointer
                  ...
                  >
                    <div className="flex items-center p-2.5 sm:p-3 pr-8 sm:pr-10">
                      <MessageSquare className={`w-4 h-4 mr-2.5 sm:mr-3 flex-shrink-0 ${
                        activeConversationId === conversation.id 
                          ? 'text-purple-600' 
                          : 'text-gray-400'
                      }`} />
                    ...
                    <div className="absolute top-2.5 sm:top-3 right-2.5 sm:right-3 opacity-0 group-hover:opacity-100 transition-opacity">
                      <ConversationMenu
        ...
        <div className="p-3 sm:p-4 border-t border-gray-200 bg-gradient-to-r from-purple-50 to-white flex-shrink-0">
          <div className="relative">
            <button
              ...
              className="w-full flex items-center space-x-2.5 sm:space-x-3 p-2.5 sm:p-3 rounded-xl sm:rounded-2xl hover:bg-white/70 transition-colors group"
            >
              <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg sm:rounded-xl bg-gradient-to-r from-purple-500 to-purple-600 flex items-center justify-center shadow-lg flex-shrink-0">
            ...
            {profileMenuOpen && (
              <div className="absolute bottom-full left-0 right-0 mb-2 bg-white/95 backdrop-blur-sm border border-gray-200 rounded-xl sm:rounded-2xl shadow-xl overflow-hidden">
      ...
      {showClearConfirm && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 max-w-sm w-full mx-4">
            <div className="mb-4 sm:mb-6">
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl sm:rounded-2xl p-3 mb-4 sm:mb-6 mt-3">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 sm:py-3 border border-gray-200 text-gray-700 rounded-xl sm:rounded-2xl hover:bg-gray-50 transition-colors font-medium text-sm"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 bg-red-500 hover:bg-red-600 text-white rounded-xl sm:rounded-2xl transition-colors font-medium px-4 py-2.5 sm:py-3 text-sm"
                >
                  Clear conversations
                </button>
              </div>
