// Pricing modal component for subscription management and upgrades
...
export function PricingModal({ isOpen, onClose, currentTier = 'free', onSelectPlan }: PricingModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-200 w-full max-w-6xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {tiers.map((tier) => {
              ...
              return (
                <div
                  key={tier.id}
                  className={`relative rounded-2xl border-2 p-6 cursor-pointer transition-all duration-200 hover:shadow-lg flex flex-col h-full ${
